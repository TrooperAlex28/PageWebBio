...
(function () {
  ...
  const translations = {
    fr: {
      ...
      "process-step-1-title": "Approche simple et efficace",
      "process-step-1-desc": "On va droit au but, sans complexité inutile.",
      ...
      "about-p2":
        "Artistes, photographes, thérapeutes, entraîneurs qui veulent une vitrine moderne pour présenter leur travail.",
      "about-p3":
        "Des solutions simples, intelligentes et orientées présence en ligne.",
      "skill-visibility": "Commerçants locaux",
      "skill-html": "Petites entreprises",
      "skill-js": "Travailleurs autonomes",
      "skill-seo": "Artistes / photographes",
      "skill-mobile": "Restaurants / cafés",
    ...
    en: {
      ...
      "process-step-1-title": "Simple, effective approach",
      "process-step-1-desc":
        "We keep things focused and avoid unnecessary complexity.",
      ...
      "skill-html": "HTML/CSS",
      "skill-js": "Independent workers",
      "skill-seo": "Artists / photographers",
      ...
      "project-4-desc":
        "Modern gallery, clear presentation, and quick contact to turn visitors into requests.",
      "tag-premium": "Fast",
      "project-5-title": "What you get",
      "project-5-desc":
        "A professional website, a better brand image, more credibility, and a solid base to attract clients.",
